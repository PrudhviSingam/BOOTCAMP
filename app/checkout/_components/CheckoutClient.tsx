    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
      ...
      >
        ...
        <button
          id="checkout-pay-btn"
          type="submit"
          className="flex items-center justify-center gap-2 w-full py-4 rounded-xl gradient-primary text-white font-bold text-base hover:opacity-90 active:scale-95 transition-all"
        >
